...
import 'package:fifa_word_cup_app/app/pages/auth/register/presenter/register_presenter.dart';
import 'package:fifa_word_cup_app/app/pages/auth/register/view/register_view_impl.dart';
                  ...
                  children: [
                    ...
                    TextFormField(
                        ...
                        validator: Validatorless.multiple([
                          ...
                          Validatorless.min(
                              6, 'Senha deve conter pelo menos 6 caracteres'),
                          Validatorless.compare(passwordEC, 'Senha não confere')
                        ])),
                    const SizedBox(
                      height: 20,
                    ),
